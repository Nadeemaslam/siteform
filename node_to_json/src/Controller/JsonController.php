...
/**
  @file
  Contains \Drupal\node_to_json\Controller\JsonController.
 */
...
class JsonController extends ControllerBase {
     ...
     * @return array
     */
    public function PageNodeAccess($apikey,NodeInterface $page_node) {
        ...
        echo t('Access Denied!');  //Access denied for wrong siteapi key.
        die();
    }
